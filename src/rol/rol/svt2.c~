...
int nvscm = 0; /* the number of vscm boards found by vscmInit() */
...
/*tiLoadTriggerTableSVT();*/
 ...
 a123:
  ...
  if(VSCM_ROFLAG==2 && nvscm==1) VSCM_ROFLAG = 1; /*no chainedDMA if one board only*/
  /*
