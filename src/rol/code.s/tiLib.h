...
struct TI_A24RegStruct
{
  ...
  /* 0x00074 */ volatile unsigned int inputPrescale;
  ...
  /* 0x000E0 */          unsigned int blank1[(0xEC-0xE0)/4];
  /* 0x000EC */ volatile unsigned int rocmask;
  /* 0x000F0 */          unsigned int blank2[(0xFC-0xF0)/4];
...
/*sergey: temporary to test hps version*/
/*#define TI_SUPPORTED_FIRMWARE 0x181*/
#define TI_SUPPORTED_FIRMWARE 0x11
