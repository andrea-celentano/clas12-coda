...
struct PartitionStruct
{
  ...
  /* 0x00n38 */          unsigned int blank0[(0x140-0x138)/4];
  /* 0x00n40 */ volatile unsigned int fpConfig;
  /* 0x00n44 */ volatile unsigned int gtpConfig;
  /* 0x00n48 */ volatile unsigned int extConfig;
...
struct TS_A24RegStruct
{
  ...
  /* 0x000E0 */          unsigned int blank1[(0xFC-0xE0)/4];
  /* 0x000FC */ volatile unsigned int blocklimit;
  /* 0x00100 */ volatile unsigned int reset;
  /* 0x00104 */          unsigned int blank2[(0x134-0x104)/4];
  ...
  /* 0x00934 */          unsigned int blank3[(0x1000-0x934)/4];
  /* 0x01000 */ volatile unsigned int GlobalTriggerTable[(0x106C-0x1000)/4];
  /* 0x0106C */          unsigned int blank7[(0x1100-0x106C)/4];
  /* 0x01100 */ volatile unsigned int GTPTriggerTable[(0x11EC-0x1100)/4];
  /* 0x011EC */          unsigned int blank8[(0x1200-0x11EC)/4];
  /* 0x01200 */ volatile unsigned int ExternalTriggerTable[(0x12EC-0x1200)/4];
  /* 0x012EC */          unsigned int blank9[(0x1300-0x12EC)/4];
  /* 0x01300 */ volatile unsigned int FPTriggerTable[(0x1320-0x1300)/4];
  /* 0x01320 */          unsigned int blank10[(0xFFFC-0x1320)/4];
...
#define TS_SUPPORTED_FIRMWARE 0x83
...
#define TS_BOARDID_TYPE_MASK     0xFFFF0000
#define TS_BOARDID_GEOADR_MASK   0x00001F00
#define TS_BOARDID_CRATEID_MASK  0x000000FF

/* opticTransceiver bits and masks */
#define TS_OPTIC_TRANSCEIVER_1 (1<<0)
#define TS_OPTIC_TRANSCEIVER_2 (1<<1)
#define TS_OPTIC_TRANSCEIVER_3 (1<<2)
#define TS_OPTIC_TRANSCEIVER_4 (1<<3)
#define TS_OPTIC_TRANSCEIVER_5 (1<<4)
#define TS_OPTIC_TRANSCEIVER_6 (1<<5)
#define TS_OPTIC_TRANSCEIVER_7 (1<<6)
#define TS_OPTIC_TRANSCEIVER_8 (1<<7)
...
#define TS_BUSY_MONITOR_TI_B     (1<<28)
...
#define TS_TRIGGERWINDOW_COINC_MASK 0x0000FFFF

/* 0x4C output bits and masks */
#define TS_OUTPUT_FP_MASK             0x0000000F
...
/* 0x48 genInput masks */
#define TS_GENINPUT_MASK 0xFFFF
...
#define TS_FIBERLATENCYMEASUREMENT_CARRYCHAIN_MASK 0x0000FFFF
#define TS_FIBERLATENCYMEASUREMENT_IODELAY_MASK    0x00FF0000
#define TS_FIBERLATENCYMEASUREMENT_DATA_MASK       0xFF000000

/* 0xA4 fiberAlignment bits and masks */
#define TS_FIBERALIGNMENT_HFBR1_IODELAY_MASK   0x000000FF
#define TS_FIBERALIGNMENT_HFBR1_SYNCDELAY_MASK 0x0000FF00
#define TS_FIBERALIGNMENT_HFBR5_IODELAY_MASK   0x00FF0000
#define TS_FIBERALIGNMENT_HFBR5_SYNCDELAY_MASK 0xFF000000
...
#define TS_SYNCEVENTCTRL_NBLOCKS_MASK 0x0000FFFF
#define TS_SYNCEVENTCTRL_ENABLE       0x005A0000
...
int  tsSetGenInput(unsigned int inputmask);
...
int  tsSetOutputPort(unsigned int set1, unsigned int set2, unsigned int set3, unsigned int set4);
...
int  tsPartSetExtInput(unsigned short input1, unsigned short input2, unsigned short input3, unsigned short input4, unsigned short input5);
