...
*/
void vscmEnableChanScalers(int id);
void vscmDisableChanScalers(int id, int chip);
void vscmClearChanScalers(int id, int chip);
int vscmReadChanScalers(int id, int chip, uint32_t *arr);
...
void fssrRegisterTest(int id, int chip);
