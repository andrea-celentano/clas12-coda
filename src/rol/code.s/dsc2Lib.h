...
int  dsc2SetTRGOut(UINT32 id, UINT16 channel, UINT16 width, UINT16 delay);
...
int  dsc2SetDelay(UINT32 id, UINT16 val, UINT16 group);
int  dsc2GetDelay(UINT32 id, UINT16 type);
int  dsc2SetTestInput(UINT32 id, UINT32 flag);
int  dsc2TestPulse(UINT32 id, UINT32 npulses);
int  dsc2LatchScalers(UINT32 id, UINT16 type);
int  dsc2SetGateSource(UINT32 id, UINT16 group, UINT32 srcMask);
UINT32 dsc2GetAdr32(int id);
int  dsc2SetAdr32(UINT32 id, UINT32 a32base, UINT16 enable);
int  dsc2Adr32Enable(UINT32 id);
int  dsc2Adr32Disable(UINT32 id);
int  dsc2Clear(UINT32 id);
int  dsc2DReady(UINT32 id);
int  dsc2ReadoutConfig(UINT32 id, UINT32 rconf, UINT32 rsrc);
int  dsc2SoftTrigger(UINT32 id);
int  dsc2ReadBlock(UINT32 id, volatile UINT32 *data, int nwrds, int rmode);
int  dsc2ReadScalers(UINT32 id, volatile UINT32 *data, int nwrds, int rflag, int rmode);
