...
#ifdef VXWORKS
  res = sysBusToLocalAdrs(0x29,(char *)ti_addr,(char **)&laddr);
#else
  res = vmeBusToLocalAdrs(0x29,(char *)ti_addr,(char **)&laddr);
#endif
...
void
statistics_vme( struct roc_stats *stats )
{
	printf("\n.........statistics........\n\n");
