...
/* tdc2.c - first readout list for CAEN TDCs */
...
/* name used by loader */
#ifdef TI_MASTER
#define INIT_NAME tdc2_master__init
...
tiSetBlockBufferLevel(1);
  ...
  printf("111\n");fflush(stdout);
  ntdcs = tdc1190Init(0x11300000,0x500000,2,0); /* for A32 use 0x11300000, for A24 - 0x300000 */
  printf("222\n");fflush(stdout);
  if(ntdcs>0)
  {
#ifdef TI_SLAVE
