...
#	lac1 cc1 cc2 ec1 ec2 sc1 tage3 pcalfb \
...
#	reset3 reset1 reset1 reset1 reset1 reset1 reset5 reset3 \
...
#	LACS CCTAG1 CC2 EC1 EC2 TOF1 PRETRG1 CLASTAG \
...
set roc_name "classc1 classc3 classc6 classc12"

set reset_line "reset4 reset4 reset4 reset4"

set target_name "CLASSC1 SC3 CLASSC6 SC12"
